...
def run_qqp_benchmark() -> dict:
    ...
    siamese_models = {
        "Siamese-LSTM": SiameseLSTM(embedding_matrix, hidden_dim=128, task="classification"),
        "Siamese-GRU": SiameseGRU(embedding_matrix, hidden_dim=128, task="classification"),
    }
